...
# NOTE: You might want to remove this if rye is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if rye has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert rye executable exists.
		local tool_cmd
